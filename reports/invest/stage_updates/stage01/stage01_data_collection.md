...
sources:
  ohlcv:
    primary: KRX/Naver 수집 경로(invest/scripts/stage01_fetch_ohlcv.py)
    full: invest/scripts/stage01_full_fetch_ohlcv.py
  supply:
    primary: invest/scripts/stage01_fetch_supply.py
    full: invest/scripts/stage01_full_fetch_supply.py
  text:
    telegram: invest/scripts/stage01_full_scrape_telegram.py
    blog: invest/scripts/stage01_scrape_all_posts_v2.py
    rss: invest/scripts/stage01_fetch_news_rss.py
run_profile:
  mode_default: incremental
  command_incremental:
    - python3 invest/scripts/stage01_daily_update.py
  command_full:
    - python3 invest/scripts/run_full_collection.py
    - python3 invest/scripts/stage01_full_fetch_ohlcv.py
    - python3 invest/scripts/stage01_full_fetch_supply.py
outputs:
  raw_root: invest/data/raw/
  health_state: memory/health-state.json
  collection_log: invest/logs/
...
## Reproduction
- run_command: "python3 invest/scripts/stage01_full_fetch_ohlcv.py"
- outputs: ["invest/data/raw/kr/ohlcv/*.csv"]