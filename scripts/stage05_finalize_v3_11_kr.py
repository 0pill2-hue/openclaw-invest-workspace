...
def main() -> int:
    ...
    numeric_top_detected = bool(best_internal.model == "numeric")
    numeric_only_auto_select_block = {
        "rule": "RULEBOOK_V3.5 Rule 6-3 Final Selection Anti-Numeric-Monopoly Gate",
        "numeric_top_detected": numeric_top_detected,
        "auto_adopt_executed": False,
        "status": "pass",
        "note": "Stage05 baseline 확정 단계에서는 numeric 단독 1등이어도 즉시 ADOPT하지 않음",
    }
    stage06_transition = {
        "entry_gate_by_stage05": "eligible" if internal_3000_gate_pass else "blocked",
        "entry_gate_reason": "internal_3000_gate_pass" if internal_3000_gate_pass else "internal_3000_gate_fail",
        "executed_in_this_round": False,
        "directive_hold": True,
        "directive_hold_reason": "결과 확정 전 Stage06 진입 금지(순차 모드)",
    }
    ...
    payload = {
        ...
        "policy_enforcement": {
            ...
            "numeric_only_auto_select_block": numeric_only_auto_select_block,
            "stage06_transition": stage06_transition,
            "rulebook_v3_5": {
    ...
    out_json = VALIDATED / "stage05_baselines_v3_11_kr.json"
        ...
        json.dumps(
            {
                ...
                "baseline_internal_best_return": best_internal.stats["total_return"],
                "internal_3000_gate_pass": "pass" if internal_3000_gate_pass else "fail",
                "numeric_only_auto_select_block": numeric_only_auto_select_block["status"],
                "stage06_entry_gate_by_stage05": stage06_transition["entry_gate_by_stage05"],
                "stage06_executed_in_this_round": stage06_transition["executed_in_this_round"],
