...
OUT_MD = Path("reports/stage_updates/STAGE05_BASELINE_FIXED_RUN_20260218.md")
OUT_JSON = Path("reports/stage_updates/STAGE05_BASELINE_FIXED_RUN_20260218.json")
LOG_DIR = Path("reports/stage_updates/logs")
