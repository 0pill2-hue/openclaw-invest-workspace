...
OUT_MD = Path("invest/reports/stage_updates/STAGE05_BASELINE_FIXED_RUN_20260218.md")
OUT_JSON = Path("invest/reports/stage_updates/STAGE05_BASELINE_FIXED_RUN_20260218.json")
LOG_DIR = Path("invest/reports/stage_updates/logs")
