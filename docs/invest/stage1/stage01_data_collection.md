...
- `invest/stages/stage1/scripts/stage01_scrape_telegram_launchd.py` *(launchd 엔트리 / canonical wrapper)*
  - secret env 존재 시: `stage01_scrape_telegram_highspeed.py` 실행 후 `stage01_telegram_attachment_extract_backfill.py` 후처리 실행
  ...
  - attachment artifact: `invest/stages/stage1/outputs/raw/qualitative/attachments/telegram/**`
  - runtime status: `invest/stages/stage1/outputs/runtime/telegram_collector_status.json`, `invest/stages/stage1/outputs/runtime/telegram_attachment_extract_backfill_status.json`
