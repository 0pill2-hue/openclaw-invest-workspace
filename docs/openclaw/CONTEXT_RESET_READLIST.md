...
5. `invest/doc/strategy/README.md`
6. `invest/doc/strategy/RULEBOOK_MASTER.md`
7. `invest/doc/strategy/PIPELINE_11_STAGE_MASTER.md`
8. `invest/doc/strategy/STAGE_STRATEGY_MASTER.md`
