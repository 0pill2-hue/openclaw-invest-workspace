...
6) `operations/OPERATIONS_BOOK.md` as the root index for operations/programs/docs map
...
- 운영 상세(컨텍스트 운영, heartbeat, task/directive 절차, 문서 체계)는 `operations/OPERATIONS_BOOK.md`를 따른다.
- 문서 위치/네이밍/작성 형식 표준은 `operations/DOCUMENT_STANDARD.md`를 따른다.
