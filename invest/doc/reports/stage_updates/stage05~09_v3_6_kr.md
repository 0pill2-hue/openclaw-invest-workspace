...
- before: docs/invest/strategy/RULEBOOK_V3.md had no explicit low-turnover 3-rule + internal 3000% gate section
- after: docs/invest/strategy/RULEBOOK_V3.md updated to V3.4 with
