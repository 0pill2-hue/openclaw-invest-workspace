...
- **판정값 파일** (근거 없음): `verdict_20260217_214510.json`
- **근거 파일** (상세 이유): `evidence/evidence_<폴더>_20260217_214510.json`
...
| :--- | :---: | ---: | ---: | ---: | ---: | :---: |
| kr/ohlcv | ⚠️ WARN | 2,883 | 2878 | 5,610,108 | 0.0% | ✅ |
...
**이슈 파일 2878개** (최대 10개 표시):

  - `000020.csv`: ohlc:Low<Close_count=2317
  - `000040.csv`: ohlc:Low<Close_count=2321
  - `000050.csv`: ohlc:Low<Close_count=2248
  - `000070.csv`: ohlc:Low<Close_count=2258
  - `000080.csv`: ohlc:Low<Close_count=2331
  - `000087.csv`: ohlc:Low<Close_count=2265
  - `000100.csv`: ohlc:Low<Close_count=2340
  - `000105.csv`: ohlc:Low<Close_count=2039
  - `000120.csv`: ohlc:Low<Close_count=2335
  - `000140.csv`: ohlc:Low<Close_count=2344
  - *... 외 2868개 → evidence 파일 참조*
...
---
*generated by validate_refine_independent.py @ 2026-02-17T21:45:35.322940*
