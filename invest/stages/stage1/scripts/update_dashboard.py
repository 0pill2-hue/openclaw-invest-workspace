...
common_input_data_dir = os.path.join(workspace_dir, 'stages/stage1/outputs')
common_output_logs_dir = os.path.join(workspace_dir, 'stages/stage1/outputs/logs/runtime')
blog_posts_dir = os.path.join(common_input_data_dir, 'raw/qualitative/text/blog')
tg_logs_dir = os.path.join(common_input_data_dir, 'raw/qualitative/text/telegram')
blog_log_path = os.path.join(common_output_logs_dir, 'blog_scrape.log')
tg_log_path = os.path.join(common_output_logs_dir, 'tg_highspeed.log')
index_html_path = os.path.join(workspace_dir, 'web/index.html')
buddies_json_path = os.path.join(common_input_data_dir, 'master/naver_buddies_full.json')
