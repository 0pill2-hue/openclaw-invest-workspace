...
- `/Users/jobiseu/.openclaw/workspace/invest/stages/stage7/docs/stage_updates/stage07_candidates_v5_kr.md`

## run_command(or process)
- `python3 scripts/stage08_cutoff_v5_kr.py` (설계 반영 대상)

## outputs
- `/Users/jobiseu/.openclaw/workspace/invest/stages/stage8/outputs/results/validated/stage08_candidates_cut_v5_kr.json`
- `/Users/jobiseu/.openclaw/workspace/invest/stages/stage8/docs/stage_updates/stage08_cutoff_v5_kr.md`
...
4) **new_selection_gate 판정**:
   ...
   - 미충족 시 상태를 `HOLD`로 표기하고 Stage09 추가검증으로 이관
5) Stage08 산출물에 gate 판정근거(수익률/MDD/turnover 비교표) 필수 기록

## quality_gates
- stage07 입력 후보 수 72 확인
- 트랙 분배 24/24/24 확인
...
## proof
- `/Users/jobiseu/.openclaw/workspace/invest/docs/strategy/RULEBOOK_V3.md`
- `/Users/jobiseu/.openclaw/workspace/invest/stages/stage8/docs/stage_updates/stage08_cutoff_design_v5_kr.md`
- `/Users/jobiseu/.openclaw/workspace/invest/stages/stage7/docs/stage_updates/stage07_candidates_v4_kr.md`
