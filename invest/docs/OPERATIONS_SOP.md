# invest/docs/OPERATIONS_SOP.md

## Purpose
운영 실행 표준(SOP) 단일 기준.  
알고리즘 개발단계 정의는 `invest/docs/STRATEGY_MASTER.md`(Stage1~6 canonical)를 따른다.

## 재현 핵심 문서
- 부트스트랩: `invest/docs/BOOTSTRAP_REPRODUCTION.md`
- Stage 실행 명세: `invest/docs/STAGE_EXECUTION_SPEC.md`
- 구조 기준: `invest/docs/INVEST_STRUCTURE_POLICY.md`
...
운영 후속(보고/전달/로그·메모리 업데이트)은 Stage6 결과 기반으로 수행한다.
