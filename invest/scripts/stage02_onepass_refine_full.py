...
def _load_processed_index():
    """
    Role: _load_processed_index 함수 역할 설명
    Input: 입력 타입/의미 명시
    Output: 반환 타입/의미 명시
...
def _save_processed_index(idx: dict):
    """
    Role: _save_processed_index 함수 역할 설명
    Input: 입력 타입/의미 명시
    Output: 반환 타입/의미 명시
    Side effect: 파일 저장/외부 호출/상태 변경 여부
    Author: 조비스
...
def _normalize_columns(df: pd.DataFrame) -> pd.DataFrame:
    """
    Role: _normalize_columns 함수 역할 설명
    Input: 입력 타입/의미 명시
    Output: 반환 타입/의미 명시
    Side effect: 파일 저장/외부 호출/상태 변경 여부
    Author: 조비스
...
def sanitize_generic_csv(df: pd.DataFrame, folder: str = ''):
    """
    Role: sanitize_generic_csv 함수 역할 설명
    Input: 입력 타입/의미 명시
    Output: 반환 타입/의미 명시
    Side effect: 파일 저장/외부 호출/상태 변경 여부
    Author: 조비스
