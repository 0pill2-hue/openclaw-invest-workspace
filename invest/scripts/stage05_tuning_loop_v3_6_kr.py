...
def write_round_report(round_no: int, cmd: str, cfg: RuleConfig, payload: dict[str, Any], pass_gate: bool, next_plan: str) -> None:
    ...
    lines = [
        ...
        f"- invest/reports/stage_updates/stage05/stage05_tuning_round_{r}.md",
        "",
        "## quality_gates",
...
def main() -> int:
    ...
    lines = [
        ...
        "- invest/reports/stage_updates/stage05/stage05_tuning_round_rXX.md",
        "- invest/reports/stage_updates/stage05/stage05_tuning_progress_v3_6_kr.md",
        "",
        "## quality_gates",
