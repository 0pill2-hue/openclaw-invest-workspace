...
def _restart_gateway() -> tuple[bool, str]:
    """
    Role: _restart_gateway 함수 역할 설명
    Input: 입력 타입/의미 명시
    Output: 반환 타입/의미 명시
    Side effect: 파일 저장/외부 호출/상태 변경 여부
    Author: 조비스
