...
def _strip_html_to_text(raw_html):
    """
    Role: _strip_html_to_text 함수 역할 설명
    Input: 입력 타입/의미 명시
    Output: 반환 타입/의미 명시
    Side effect: 파일 저장/외부 호출/상태 변경 여부
    Author: 조비스
...
def _extract_posts_from_rss(blog_id: str):
    ...
    Role: _extract_posts_from_rss 함수 역할 설명
    Input: 입력 타입/의미 명시
    Output: 반환 타입/의미 명시
    Side effect: 파일 저장/외부 호출/상태 변경 여부
    Author: 조비스
...
def _extract_posts_from_html(list_url):
    ...
    Role: _extract_posts_from_html 함수 역할 설명
    Input: 입력 타입/의미 명시
    Output: 반환 타입/의미 명시
    Side effect: 파일 저장/외부 호출/상태 변경 여부
    Author: 조비스
...
def _parse_post_date(date_raw: str):
    ...
    Role: _parse_post_date 함수 역할 설명
    Input: 입력 타입/의미 명시
    Output: 반환 타입/의미 명시
    Side effect: 파일 저장/외부 호출/상태 변경 여부
    Author: 조비스
...
def _extract_posts_with_browser(list_tab_id, bid):
    """
    Role: _extract_posts_with_browser 함수 역할 설명
    Input: 입력 타입/의미 명시
    Output: 반환 타입/의미 명시
    Side effect: 파일 저장/외부 호출/상태 변경 여부
    Author: 조비스
